...
$pendidikan     = get_data( "SELECT * FROM kb_pendidikan WHERE id_user = '$_SESSION[id_user]'" );
$penelitian     = get_data( "SELECT * FROM kb_penelitian WHERE id_user = '$_SESSION[id_user]'" );
$pengabdian     = get_data( "SELECT * FROM kb_pengabdian_masy WHERE id_user = '$_SESSION[id_user]'" );
$penunjang_lain = get_data( "SELECT * FROM kb_penunjang_lain WHERE id_user = '$_SESSION[id_user]'" );
$kewajiban      = get_data( "SELECT * FROM kewajiban_khusus WHERE id_user = '$_SESSION[id_user]'" );
$logo = get_data('SELECT * FROM logo where id = 1');
//var_dump( $identitas);
?>
<div class="Section1" style="padding-top:300px">
    <div class="logo">
        <img class="images" src="<?php echo $logo[0]->url?>" width="50%">
    </div>
    ...
    <table id="header-table" width="100%">
        ...
        <tr id="heading">
            <td colspan="3">
                <h5>IV. BIDANG PENGABDIAN KEPADA MASYARAKAT</h5>
            </td>
        </tr>
        ...
        <tr id="heading">
            <td colspan="3">
                <h5>V. BIDANG PENUNJANG LAINNYA</h5>
            </td>
        </tr>
